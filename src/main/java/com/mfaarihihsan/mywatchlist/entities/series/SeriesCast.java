...
@Data
@NoArgsConstructor
public class SeriesCast extends Cast {
    ...
    public SeriesCast(Integer id, String name, Integer actorId, String character, boolean isMain, boolean isSupport, boolean isGuest, List<Integer> appearOnEpisodes) {
